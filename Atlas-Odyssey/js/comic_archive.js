...
writeArchive("chapter0", 1, 3, -1, false,false); //writeArchive is for listing a RANGE of pages, take advantage of this by using headers to divide them into chapters or by month

writeArchive("chapter1", 4, maxpg, -1, false,false);
...
function writeArchive(divClass, min, max, reverseOrder, useNums) {
